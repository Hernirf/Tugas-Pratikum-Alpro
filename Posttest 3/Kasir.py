...
while i=="y":
    ...
    if Kode=="1":
        ...
        if pesanan=="a" or pesanan=="A":
            ...
            harga=Makanan["Soto Ayam"]*jumlah
        elif pesanan=="b" or pesanan=="B":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Makanan["Mie Ayam"]*jumlah
        elif pesanan=="c" or pesanan=="C":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Makanan["Bakso"]*jumlah
        elif pesanan=="d" or pesanan=="D":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Makanan["Ayam Bakar"]*jumlah 
        elif pesanan=="e" or pesanan=="E":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Makanan["Batagor"]*jumlah 
        else:
        ...
        if pesanan=="a" or pesanan=="A":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Minuman["Es Teh"]*jumlah
        elif pesanan=="b" or pesanan=="B":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Minuman["Air Mineral"]*jumlah
        elif pesanan=="c" or pesanan=="C":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Minuman["Es Jeruk"]*jumlah
        elif pesanan=="d" or pesanan=="D":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Minuman["Jus Buah"]*jumlah 
        elif pesanan=="e" or pesanan=="E":
            jumlah=int(input("Masukkan jumlah pesanan: "))
            harga=Minuman["Es Campur"]*jumlah
        else:
            print("Mohon maaf menu tidak tersedia")
        jumlahMinum+=jumlah
